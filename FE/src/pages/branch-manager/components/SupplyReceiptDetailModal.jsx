...
import {
  ...
  getReceiptDetail,
  rejectReceipt,
} from '../../../api/branchReceiving.js';

export default function SupplyReceiptDetailModal({ open, receiptId, onClose, onChanged }) {
  ...
  async function act(kind) {
    ...
    try {
      ...
      const refreshed = await getReceiptDetail(receiptId);
      setDetail(refreshed);
      onChanged?.();
    } catch (err) {
  ...
  return (
    <Modal
      ...
      description="Review received quantities before approving branch stock update."
      size="xl"
      footer={
